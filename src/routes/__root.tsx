...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Elliot" },
      { name: "description", content: "Elliot is a thoughtful AI companion with quiet memory and polished chat." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Elliot" },
      { property: "og:description", content: "Elliot is a thoughtful AI companion with quiet memory and polished chat." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Elliot" },
      { name: "twitter:description", content: "Elliot is a thoughtful AI companion with quiet memory and polished chat." },
